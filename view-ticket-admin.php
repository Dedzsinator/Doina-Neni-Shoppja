...
?>
  ...
  <head>
    ...
    <title>Probléma száma <?php echo $ticket_id . ' - ' . $type; ?></title>
            ...
            <div class="container">
              <div class="row">
                <div class="col s12 m12 l12">
                  <h5 class="breadcrumbs-title">Adj meg információkat</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="section">
              ...
              echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title white-text darken-1">Probléma száma. ' . $ticket_id . '</span>
										<p><strong>Téma: </strong>' . $subject . '</p>
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message.php" novalidate="novalidate" class="col s12">					  
					  ...
					  <input type="hidden" name="ticket_id" value="' . $ticket_id . '">
                        <div class="input-field col s12">
                          ...
                          <label for="message" class="">Válasz</label>
						  <div class="errorTxt1"></div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Válasz
