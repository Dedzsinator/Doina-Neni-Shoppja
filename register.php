      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="name" class="center-align">Név</label>
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Van már fiókod? <a href="login.php">Bejelentkezés</a></p>
          </div>
        </div>
      </form>
    </div>
    ...
    $("#formValidate").validate({
        ...
        messages: {
            ...
            phone:{
				...
				minlength: "Minimum 4 karakter kötelező."
			},		
        },
        errorElement : 'div',
